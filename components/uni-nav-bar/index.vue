					...
					<slot name="left">
						<view class="header_left_info"
							...
							<view class="header_left_back" :class="[ isTwoBtn ? 'header_btnMongol_left_back' : '' ]"
								...
								<image class="header_icon" v-else src="/static/nav-bar/icon_back_black.png"
							...
							<view class="header_left_home" :class="[isTwoBtn ? 'header_btnMongol_left_home' : '']"
								...
								<image class="header_icon" v-if="isWhite" src="/static/nav-bar/icon_back_white.png"
									mode="aspectFit"></image>
								<image class="header_icon" v-else src="/static/nav-bar/icon_home_black.png"
									mode="aspectFit"></image>
							</view>
						</view>
					</slot>
